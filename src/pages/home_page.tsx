...
const transactions = [
    ...
    {
        id: 3,
        name: 'Payment from Jeffrey Allen',
        href: '#',
        amount: '$10,000',
        currency: 'USD',
        status: 'processing',
    ...
    {
        id: 4,
        name: 'Payment from Donald Trump',
        href: '#',
        amount: '$5,000',
        currency: 'USD',
        status: 'failed',
...
const cards = [
    { name: 'Weekly Balance', href: '#', icon: CurrencyDollarIcon, amount: '$30,659.45', extraInfo: '1 Cancelled Play', extraInfoTwo: 'https://book32.com/weekly-balance' },
    { name: 'Hstack8', href: '#', icon: UserIcon, amount: 'KingPin', extraInfo: 'Agent PIN: 1286750', extraInfoTwo:  'http://book32.com/hstack8'},
]
        ...
        <div>
            ...
            <div className="mt-8">
                <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                    <h2 className="text-lg leading-6 font-medium text-gray-900">Player Overview</h2>
                                        ...
                                        <div className="ml-5 w-0 flex-1">
                                            <dl>
                                                ...
                                                <dd>
                                                    ...
                                                    <div className="text-lg font-medium text-gray-900">{card.extraInfo}</div>
                                                    <div className="text-lg font-medium text-gray-900">{card.extraInfoTwo}</div>
                                                </dd>
                                            </dl>
                                        </div>
                                    </div>
